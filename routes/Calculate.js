...
route.post('/getDayOfExercise', async(req, res)=>{
    ...
    try{
        ...
        if(days.length > 0){
            ...
            main_carbohydrate_gram = main * 0.30 / 4;
            main_protein_gram = main * 0.4 / 4;
            main_fat_gram = main * 0.30 / 9;
            ...
            if(user_data[0].gender == 1){
                // console.log("a boy");
                bmr = 66 + (13.7 * user_data[0].weight) + (5 * user_data[0].height) - (6.8 * age);
                // console.log(bmr);
            }else{
                // console.log("a girl");
                bmr = 665 + (9.6 * user_data[0].weight) + (1.8 * user_data[0].height) - (4.7 * age);
                // console.log(bmr);
            }
            tdee = bmr * 1.2;
            bulk = tdee + 200;
